...
<div id="categories" style="width:500px;float:left">
    Размещение:<br>
...
<script>
    ...
    $(function () {
        //console.log('>> ' + goodsCatalog);
        /*goodsCatalog = {
         //id          : "string" // will be autogenerated if omitted
         text        : "sssssff", // node text
         ...
         //            },
         children    : ['1', '2']  // array of strings or objects
         //li_attr     : {}  // attributes for the generated LI node
         //a_attr      : {}  // attributes for the generated A node
         };*/

        /*$('#positions_cid').jstree({ 'core' : {
         'data' : [
         'Simple root node',
         {
         'text' : 'Root node 2',
        ...
        /*for (var key in goodsCatalog) {
         var elem = goodsCatalog[key];
         goodsCatalog[key].text = elem.data;
         }*/
        prepCat(goodsCatalog);
        $('#positions_cid').jstree({'core': {'data': [goodsCatalog]}});
    });
